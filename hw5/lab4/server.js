...
// Задача 1 - ЗаголовокRange: bytes=0-
///  на плеере работают только кноки play и stop + после запроса все видео загрузилось
// В этом описании и минус данного способа
...
http.createServer((request, response) => { // вызов метода создания http сервера
    ...
    extname = path.extname(pathname); // смотрим на расширение файлы
    console.log(extname);
...
console.log(range);
   ...
   // 2. Status Code: 206 -  панель управления видео работает отлично за счет изменений код и появилась частничная отдача кода
   // 3. расширила  mime-types